package com.example.xlm.mydrawerdemo.zxing.activity;
...
import com.example.xlm.mydrawerdemo.zxing.camera.CameraManager;
import com.example.xlm.mydrawerdemo.zxing.decoding.CaptureActivityHandler;
import com.example.xlm.mydrawerdemo.zxing.decoding.InactivityTimer;
import com.example.xlm.mydrawerdemo.zxing.decoding.RGBLuminanceSource;
import com.example.xlm.mydrawerdemo.zxing.view.ViewfinderView;
            ...
            switch (requestCode) {
                case REQUEST_CODE_SCAN_GALLERY:
                    ...
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            Log.d("spq","xxxxxxxxxxxxxxxxxxxxxxxxxxxxx>>>>>>");
