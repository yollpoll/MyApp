...
public class EmojiUtils {
    public static String[] wordEmoji = new String[]{
            "|∀ﾟ", "(´ﾟДﾟ`)", "(;´Д`)",
            "(｀･ω･)", "(=ﾟωﾟ)=", "| ω・´)",
            "|-` )", "|д` )", "|ー` )",
            "|∀` )", "(つд⊂)", "(ﾟДﾟ≡ﾟДﾟ)",
    ...
    public static int[] picLwnEmoji = new int[]{
    ...
    //获取颜文字列表
    public static List<String> getWordEmojiList() {
        List<String> emojiList = new ArrayList<>();
        for (int i = 0; i < wordEmoji.length; i++) {
    ...
    //获取芦苇娘表情列表
    public static List<Integer> getPicLwnEmojiList() {
        List<Integer> emojiList = new ArrayList<>();
        for (int i = 0; i < picLwnEmoji.length; i++) {
